...
public class ListPopupWindow {
    ...
    class C02031 extends ForwardingListener {
        C02031(View x0) {
            super(x0);
        }
        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case C0165R.styleable.Toolbar_collapseContentDescription /*19*/:
                        case C0165R.styleable.Toolbar_navigationIcon /*20*/:
                        case C0165R.styleable.Toolbar_titleTextColor /*23*/:
                        case C0165R.styleable.Theme_textAppearanceSearchResultSubtitle /*66*/:
                            return true;
                    }
