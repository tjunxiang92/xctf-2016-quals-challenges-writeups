...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01932 implements OnApplyWindowInsetsListener {
        C01932() {
        }
    ...
    class C01943 implements OnFitSystemWindowsListener {
        C01943() {
        }
    ...
    class C01954 implements OnAttachListener {
        C01954() {
        }
    ...
    class C02076 extends ViewPropertyAnimatorListenerAdapter {
        C02076() {
        }
        ...
        if (a.hasValue(C0131R.styleable.Theme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C01932());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C01943());
                }
            ...
            abcContent.setAttachListener(new C01954());
            return subDecor;
        }
        a.recycle();
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C02076());
                    if (this.mActionModePopup != null) {
