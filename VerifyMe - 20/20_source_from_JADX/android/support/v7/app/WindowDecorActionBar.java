...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C01983 implements ViewPropertyAnimatorUpdateListener {
        C01983() {
        }
    ...
    class C02091 extends ViewPropertyAnimatorListenerAdapter {
        C02091() {
        }
    ...
    class C02102 extends ViewPropertyAnimatorListenerAdapter {
        C02102() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C02091();
        this.mShowListener = new C02102();
        this.mUpdateListener = new C01983();
