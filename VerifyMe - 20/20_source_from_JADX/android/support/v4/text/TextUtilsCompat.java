...
import xctf.nus.xverifier.BuildConfig;
    ...
    private static class TextUtilsCompatImpl {
        ...
        public String htmlEncode(@NonNull String s) {
            ...
            for (int i = 0; i < s.length(); i++) {
                char c = s.charAt(i);
                switch (c) {
                    case C0165R.styleable.Theme_actionModePasteDrawable /*34*/:
                        sb.append("&quot;");
                        break;
                    case C0165R.styleable.Theme_actionModeWebSearchDrawable /*38*/:
                        sb.append("&amp;");
                        break;
                    case C0165R.styleable.Theme_actionModePopupWindowStyle /*39*/:
                        sb.append("&#39;");
                        break;
                    case C0165R.styleable.Theme_popupMenuStyle /*60*/:
                        sb.append("&lt;");
                        break;
                    case C0165R.styleable.Theme_editTextColor /*62*/:
                        sb.append("&gt;");
                        break;
                    default:
                        sb.append(c);
