...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01861 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01861() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01861());
        }
                ...
                if (lp.isDecor) {
                    ...
                    switch (vgrav) {
                        case DEFAULT_GUTTER_SIZE /*16*/:
                            ...
                            break;
                        case C0165R.styleable.Theme_homeAsUpIndicator /*48*/:
                            childTop = paddingTop;
                            paddingTop += child.getMeasuredHeight();
                            break;
                        case C0165R.styleable.Theme_panelMenuListTheme /*80*/:
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case C0165R.styleable.Toolbar_navigationContentDescription /*21*/:
                return arrowScroll(17);
            case C0165R.styleable.Toolbar_logoDescription /*22*/:
                return arrowScroll(66);
            case C0165R.styleable.Theme_popupWindowStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
